...
in temp, TIFR1
andi temp, 1<<OCF1A 
; andi --> 1 (OCF1A é um)	--> overflow - JÁ PASSOU delay SEGUNDOS!
; andi --> 0 (OCF1A é zero)	--> contando - ainda tá contando
breq facaNada ; veja se os 2 são zero. se sim, ainda está contando.

; chegou aqui? o tempo já deu! reset a bandeira 
ldi temp, 1<<OCF1A ;write a 1 to clear the flag
out TIFR1, temp ; com está no modo CTC, o registrador do temporizador, TCNT1, é zerado
